...
public class LocFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        sendToUserActivity(remoteMessage.getNotification(), longitude, latitude, mobile);
        Log.d(TAG, "longitude: "+ longitude + " latitude: " + latitude);
    }

    private void sendToUserActivity(RemoteMessage.Notification notification, String longitude, String latitude, String mobile) {
