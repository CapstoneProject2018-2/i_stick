...
public class EditParentInfo extends AppCompatActivity {
    private String id, name, mobile;  //  from ParentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameTextView = (TextView) findViewById(R.id.id_name);
        nameTextView.setText(name);
        mobileTextView = (TextView) findViewById(R.id.phone_number);
