...
public class DeviceControlActivity extends Activity {
   ...
   // private String mDeviceName_1;
    ...
    private TextView firstX, firstY;
    private TextView newX, newY;
        ...
        public void onReceive(Context context, Intent intent) {
           ...
           //  displayData(intent.getStringExtra(BluetoothLeService.EXTRA_DATA));
               ...
               // ++i;++i;                                                // FOR SKIPPING CHECKSUM
                ...
                newX.setText("latitude: "+ latitude + final_data[0]);
                newY.setText("longitude: "+ longitude + final_data[1]);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        checkAndRequestWriteLog(); //내부 스토리지 권한 획득
       ...
       // mDataField = (EditText) findViewById(R.id.connection_state);
        ...
        firstX = (TextView)findViewById(R.id.firstX);
        firstY = (TextView)findViewById(R.id.firstY);
        newX = (TextView)findViewById(R.id.newX);
        newY = (TextView)findViewById(R.id.newY);
        ...
        if(location !=null && location.getTime() > Calendar.getInstance().getTimeInMillis() - 2 * 60 * 1000){
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, new LocationListener() {
                ...
                public void onLocationChanged(Location location) {
                    ...
                    firstX.setText("latitude: "+latitude+"");
                    firstY.setText("longitude: " +longitude+"");
...
void writeack(byte[] byteArray){
    ...
    private  void checkAndRequestWriteLog(){ //내부 스토리지 권한 획득 (log 쓰는용)
